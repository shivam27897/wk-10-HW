...
public class Edge {
    public static void main(String[] args) {
        ...
        System.setProperty("webdriver.Edge.driver", "src/drivers/msedgedriver.exe"); //setting web driver
        WebDriver driver = new EdgeDriver();  //creating object of chrome web driver
